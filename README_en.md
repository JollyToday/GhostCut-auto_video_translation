...
* 03.09-#GhostCut Translation Product Update: All translation engines call ChatGPT, with higher accuracy, especially for translation between small languages;
...
1. **[Video Text auto Removal]** Automatically detect all text in the video through OCR and perform inpainting smudging to restore the erased video parts as much as possible;
2. **[Video Text Auto Translation]** Automatically detect the subtitles in the video through OCR, calculate and extract the position, style, size, etc. of the text in the video, and then use ChatGPT to translate the subtitles and paste them back according to the original text style and position, while performing inpainting smudging on the original text;
...
### Video Micro-Editing/Video Deduplication Related
...
### Text Removal and Video Inpainting Related
...
* Support automatic detection of video subject and upper and lower edges, and refill the background outside the video subject

### Video Voice Translation Related
...
* Support mute after translation, retain background sound, algorithmic music matching or specified music matching
...
### Video Text Translation Related
...
## 5. Technical Details
* Voice: Self-developed ASR and TTS combined with engines such as iFlytek, Alibaba Cloud, Google, Microsoft, and Volcano; 
